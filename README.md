...
3. If you're working with the [LF](https://www.linuxfoundation.org/), join [slack.cncf.io](https://slack.cncf.io) and join #landscapers. If you're working outside the LF, we don't formally support landscapes outside the LF but feel free to join the Slack and ask for help.
